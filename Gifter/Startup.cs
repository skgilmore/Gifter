...
namespace Gifter
{
    public class Startup
    {
        ...
        // We update the original Conifigure to allow for a more open access line while in the Development stage of our app.
        //IF YOU GET A CORS ERROR THIS IS LIKELY WHY
